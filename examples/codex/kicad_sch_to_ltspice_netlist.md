...
```json
{"tool":"execute","arguments":{"api_name":"kicad_sch_to_ltspice_netlist","inputs":{"kicad_sch_filepath":"/home/brosnan/bltspice_mcp/bltspice_mcp/testfiles/rc-filter.kicad_sch","ltspice_netlist_filepath_out":"/tmp/rc-filter.net"}}}
```
...
```json
{"tool":"execute","arguments":{"api_name":"kicad_sch_to_ltspice_netlist","inputs":{"kicad_sch_filepath":"/abs/input.kicad_sch","ltspice_netlist_filepath_out":"/abs/output.net","convert_settings":{"kicad_path":"/usr/share/kicad/"}}}}
```
