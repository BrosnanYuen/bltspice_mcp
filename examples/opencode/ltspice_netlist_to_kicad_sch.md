...
```json
bltspice_mcp_execute {"api_name":"is_valid_ltspice_netlist_file","inputs":{"filepath":"/home/brosnan/bltspice_mcp/bltspice_mcp/testfiles/testfile.net"}}
```
3. Convert the netlist:
```json
bltspice_mcp_execute {"api_name":"ltspice_netlist_to_kicad_sch","inputs":{"ltspice_netlist_filepath":"/home/brosnan/bltspice_mcp/bltspice_mcp/testfiles/testfile.net","kicad_sch_filepath_out":"/tmp/testfile.kicad_sch"}}
```
...
```json
bltspice_mcp_execute {"api_name":"ltspice_netlist_to_kicad_sch","inputs":{"ltspice_netlist_filepath":"/abs/input.net","kicad_sch_filepath_out":"/abs/output.kicad_sch","convert_settings":{"kicad_path":"/usr/share/kicad/"}}}
```
